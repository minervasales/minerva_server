      ...
      switch (status) {
         ...
         case "Order Completed":
            ...
            await prisma.product.update({
               ...
               data: {
                  newQuantity: getProductID.newQuantity - orders.quantity,
               },
            });
            ...
            <body style="box-sizing:  border-box; margin: 0; padding: 0;">
                <table style="width: 500px; height: auto; ">
                    ...
                    <tr style=" height: 60px;">
                        <td style="font-family: Poppins;">Your order ${orders.orders} has been successfully completed. We hope to do
