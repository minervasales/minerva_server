...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'archive' | 'profile' | 'services' | 'product' | 'schedule' | 'logs' | 'orders' | 'about' | 'contacts'
  ...
  export type ContactsWhereInput = {
    ...
    image?: StringFilter<"Contacts"> | string
  ...
  export type ContactsScalarWhereWithAggregatesInput = {
    ...
    image?: StringWithAggregatesFilter<"Contacts"> | string
